...
class ModifierContrainteTest extends TestCase
{
    ...
    public function test_modifier_contrainte_invalide(): void{
        //Effectuer la requête
        $response = $this->putJson('/api/contrainte/0', $this->contrainteData);
        //Tester le résultat de la requête
        $response
            ->assertStatus(404);
    }
    ...
    //VALIDATION : NOM
    public function test_modifier_contrainte_invalide_nom_required(): void{
    ...
    public function test_modifier_contrainte_invalide_nom_maxlength_50(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
    ...
    //VALIDATION : TYPE
    public function test_modifier_contrainte_invalide_type_required(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
    ...
    //VALIDATION : STRICTE
    public function test_modifier_contrainte_invalide_stricte_required(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
    ...
    public function test_modifier_contrainte_invalide_stricte_boolean(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
    ...
    //VALIDATION : SESSION
    public function test_modifier_contrainte_invalide_session_required_quand_type_est_generaux(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
    ...
    public function test_modifier_contrainte_invalide_session_integer(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
    ...
    public function test_modifier_contrainte_invalide_session_min_0(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
    ...
    public function test_modifier_contrainte_invalide_session_max_6(): void{
        //Récupérer les données
        $contrainteDataInvalide = $this->contrainteData;
        //Changer pour des données invalides
