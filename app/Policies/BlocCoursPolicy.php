...
class BlocCoursPolicy
{
     ...
     */
    public function update(User $user, BlocCours $bloccour): bool
    {
        $lsRoles =$user->role;
        return $this->validerRole($lsRoles,["Administrateur","Coordonnateur"]);
    }
     ...
     */
    public function delete(User $user, BlocCours $bloccour): bool
    {
        $lsRoles =$user->role;
        return $this->validerRole($lsRoles,["Administrateur","Coordonnateur"]);
    }
     ...
     */
    public function restore(User $user, BlocCours $blocCours): bool
    {
        //
    }
     ...
     */
    public function forceDelete(User $user, BlocCours $blocCours): bool
    {
        //
    }
